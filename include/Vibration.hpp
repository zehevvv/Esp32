...
public:
    ...
    uint8_t GetMaxPower();
    void SetEnableVibration(bool enable);
...
private:    
    ...
    static const string REGISRTY_NAME_ENABLE_VIBRATION;
    static const bool DEFAULT_ENABLE_VIBRATION = true;
